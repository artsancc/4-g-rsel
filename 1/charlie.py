...
cv2.putText(img, "Charlie Cizim", (50, 50), font, 1, BEYAZ, 2)
...
while True:
    ...
    if tus == ord('q'):
        ...
        cv2.circle(img, (250, 450), 100, MAVI, ORTA)
        print("Veri Güncellendi: Mavi Daire Eklendi.")

    elif tus == ord('r'):
        cv2.rectangle(img, (200, 800), (400, 250), YESIL, ORTA)
        print("Veri Güncellendi: Yeşil Dikdörtgen Eklendi.")

    elif tus == ord('l'):
        cv2.line(img, (50, 400), (500, 400), SARI, KALIN)
