...
cv2.putText(img, "Paragliding", (50, 50), font, 1, BEYAZ, 2)

print("\n--- KONTROLLER ---")
print("c: Daire (Circle) - Mavi")
print("r: Dikdörtgen (Rectangle) - Yeşil")
print("l: Çizgi (Line) - Sarı")
...
while True:
    ...
    if tus == ord('q'):
        ...
        cv2.circle(img, (400, 150), 100, MAVI, ORTA)
        print("Veri Güncellendi: Mavi Daire Eklendi.")

    elif tus == ord('r'):
        cv2.rectangle(img, (600, 450), (1000, 650), YESIL, ORTA)
        print("Veri Güncellendi: Yeşil Dikdörtgen Eklendi.")

    elif tus == ord('l'):
        cv2.line(img, (650, 40), (700, 400), SARI, KALIN)
