...
cv2.putText(img, "Alice Cizim", (50, 50), font, 1, BEYAZ, 2)
...
while True:
    ...
    if tus == ord('q'):
        ...
        cv2.circle(img, (350, 600), 100, MAVI, ORTA)
        print("Veri Güncellendi: Mavi Daire Eklendi.")

    elif tus == ord('r'):
        cv2.rectangle(img, (100, 450), (250, 200), YESIL, ORTA)
        print("Veri Güncellendi: Yeşil Dikdörtgen Eklendi.")

    elif tus == ord('l'):
        cv2.line(img, (130, 700), (630, 700), SARI, KALIN)
